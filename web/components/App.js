...
class App extends React.Component {
  ...
  renderTopbar(){
    ...
    const currentArticle = R.find((article) => article.id === articleId, articles);
    const isEditableArticle = (currentArticle && currentArticle.author.name === user.name);
  ...
  render(){
    return <div>
      ...
      <Route exact path="/articles/:articleId/edit" component={ArticleEditor}/>
    </div>
  }
}
