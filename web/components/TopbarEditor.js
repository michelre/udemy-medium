...
class TopbarEditor extends React.Component {
  ...
  renderTooltipPublish() {
    ...
    return (
      ...
      >
        <TooltipPublish
          tooltipRef={this.publishTooltipRef}
        ...
        <div>
          <div className="title-container">
            ...
            {!article || !article.pubDate ? (
              <div className="m-r-md">Draft</div>
            ) : null}
            ...
            <div>
              ...
              <div
                ...
                ref={e => (this.publishTooltipRef = e)}
                data-for="tooltip-publish"
                data-tip="tooltip-publish"
              >
                Publish <i className="fa fa-angle-down" />
              </div>
              {this.renderTooltipPublish()}
              <i
                className="other-actions cursor-pointer"
                data-for="tooltip-actions"
                data-tip="tooltip-actions"
              >
                ...
              </i>
              <ReactTooltip
